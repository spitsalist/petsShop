import { Dialog, DialogActions, DialogContent, DialogTitle, Button, Box, DialogContentText } from '@mui/material';
...
const DialogWindow = ({ open, handleClose, WindowText }) => {
  ...
  return (
    ...
    >
      <Box sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between', ...dialogStyles }}>
        <DialogTitle sx={dialogStyles} id="alert-dialog-title">
          {"Congratulations!"}
        </DialogTitle>
        <DialogActions sx={dialogStyles}>
          <Button sx={dialogStyles} onClick={handleClose}>x</Button>
        </DialogActions>
      </Box>
